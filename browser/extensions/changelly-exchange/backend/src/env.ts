...
const Schema = z.object({
  ...
  CHANGELLY_FIAT_API_BASE_URL: z.string().url().default("https://fiat-api.changelly.com"),
  CHANGELLY_FIAT_API_PUBLIC_KEY: z.string().optional(),
  CHANGELLY_FIAT_API_PRIVATE_KEY: z.string().optional(),
