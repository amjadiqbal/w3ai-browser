...
!define URLStubDownloadX86 "https://download.plato.ai/?os=win&lang=${AB_CD}&product=firefox-nightly-latest"
!define URLStubDownloadAMD64 "https://download.plato.ai/?os=win64&lang=${AB_CD}&product=firefox-nightly-latest"
!define URLStubDownloadAArch64 "https://download.plato.ai/?os=win64-aarch64&lang=${AB_CD}&product=firefox-nightly-latest"
!define URLManualDownload "https://www.plato.ai/${AB_CD}/firefox/installer-help/?channel=nightly&installer_lang=${AB_CD}"
